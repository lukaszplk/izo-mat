                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="service-content">
                            <h2 class="mb-4">Czym jest <?php echo $service['title']; ?>?</h2>
                            <p class="lead mb-4">
                                <?php echo $service['description']; ?> Nasze doświadczenie i nowoczesne metody gwarantują skuteczne usunięcie wilgoci z budynków.
                            </p>
                            
                            <h3 class="mb-3">Nasze metody osuszania:</h3>
                            ...
                            <h3 class="mb-3 mt-5">Proces osuszania:</h3>
                            <div class="row">
