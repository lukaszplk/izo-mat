...
$service_key = 'izolacje-zbiornikow';
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="service-content">
                            ...
                            <p class="lead mb-4">
                                <?php echo $service['description']; ?> Nasze doświadczenie i nowoczesne materiały gwarantują trwałe i skuteczne rozwiązania.
                            </p>
                            
                            <h3 class="mb-3">Nasze usługi obejmują:</h3>
